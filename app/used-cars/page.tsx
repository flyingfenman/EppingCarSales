            ...
            {sortedCars.map((car) => (
              <Card key={car.id} className="overflow-hidden group">
                <div className="relative h-48">
                  {car.sold && (
                    <div className="absolute top-2 left-2 z-10 px-3 py-1 rounded-md font-semibold text-sm bg-gray-400 text-white opacity-50 group-hover:bg-red-600 group-hover:opacity-100 transition-all duration-300">
                      SOLD
                    </div>
                  )}
